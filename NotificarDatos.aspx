<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="NotificarDatos.aspx.cs" Inherits="NotificarDatos" EnableEventValidation = "false" Buffer="true" %>
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            <main id="main1" class="main">
                <div class="pagetitle">
                    ...
                    <nav>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Notificacion de datos</li>
                ...
                <asp:HiddenField runat="server" ID="HiddenFieldCollapseNotificarDatos_selected" Value="0"/>
                ...
                <section class="section dashboard">
                    ...
                    <!-- PanelNotificarDatos -->
                    <div id="divPanelNotificarDatos" runat="server" visible="false">
                        <div class="accordion" id="divAccordionNotificarDatos">

                          <div class="accordion-item">
                            <h2 class="accordion-header">
                              <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseContenido_filtroNotificarDatos" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
                                Enviar datos de alta de usuario
                              </button>
                            </h2>
                            <div id="collapseContenido_filtroNotificarDatos" class="accordion-collapse collapse">
                                ...
                                <asp:UpdatePanel runat="server">
                                    <ContentTemplate>
                                        ...
                                        <section>
                                            <div class="row mb-3">
                                                <div class="mb-3">
                                                <label for="TextBoxNotificarDatos_correo" class="form-label">Correo electrónico</label>
                                                    <asp:TextBox runat="server" ID="TextBoxNotificarDatos_correo" CssClass="form-control"></asp:TextBox>
                                                    <div id="emailHelp" class="form-text">Ingrese el correo electrónico al que será enviada la información.</div>
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="TextBoxNotificarDatos_usuario" class="form-label">Usuario</label>
                                                    <asp:TextBox runat="server" ID="TextBoxNotificarDatos_usuario" CssClass="form-control"></asp:TextBox>
                                                </div>
                                                <div class="mb-3 col-md-6">
                                                    <label for="TextBoxNotificarDatos_password" class="form-label">Password</label>
                                                    <asp:TextBox runat="server" ID="TextBoxNotificarDatos_password" CssClass="form-control"></asp:TextBox>
                                                </div>

                                                <div class="d-grid gap-2">
                                                    <asp:Label runat="server" ID="LabelEnvioCorreo_estatus"></asp:Label>
                                                    <asp:LinkButton runat="server" ID="LinkButtonNotificarDatos_enviar" CssClass="btn btn-outline-success LoadingOverlay" OnClick="LinkButtonNotificarDatos_enviar_Click" Text="Enviar correo"></asp:LinkButton>
                                                </div>
    ...
    <script>
        ...
        function validarCollapse() {
            ...
            $('.accordion-collapse').on('hide.bs.collapse', function (e) {
                ...
                switch (idCollapse) {
                    case 'collapseContenido_filtroNotificarDatos':
                        $("[id*=HiddenFieldCollapseNotificarDatos_selected]").val("0");
                        break;
                }
            ...
            let collSt = $("[id*=HiddenFieldCollapseNotificarDatos_selected]").val();

            if (collSt == "1") { ActivarCollapse("collapseContenido_filtroNotificarDatos"); }
