<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PeticionAsignar.aspx.cs" Inherits="PeticionAsignar" EnableEventValidation = "false" Buffer="true" %>
...
<asp:Content ID="contentPeticionesAdmon" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <asp:UpdatePanel runat="server">
        <ContentTemplate>
            <main id="main1" class="main">
                ...
                <asp:HiddenField runat="server" ID="HiddenFieldCollapseAsignarPeticion_selected" Value="0"/>
                <asp:HiddenField runat="server" ID="HiddenFieldMensajeRegistroExitoso_estatus" Value=""/>
                <asp:HiddenField runat="server" ID="HiddenFieldGraficoPiePeticiones_datos" Value=""/>
                ...
                <section class="section dashboard">
                    ...
                    <!-- PanelAsignarPeticion -->
                    <div id="divPanelAsignarPeticion" runat="server" visible="false">
                        <div class="accordion" id="divAccordionAsignarPeticion">
                                               ...
                                               <div class="row">
                                                 ...
                                                 <div class="col-md-6">
                                                   <div class="card info-card sales-card">
                                                     ...
                                                     <div class="card-body">
                                                       <h5 class="card-title">Por asignar <span>| peticiones</span></h5>

                                                       <div class="d-flex align-items-center">
                                                         <div class="card-icon rounded-circle d-flex align-items-center justify-content-center" style="background:#ffE599">
                                                             <i class="bi bi-x-octagon text-yellow"></i>
                                                         </div>
                                                         <div class="ps-3">
                                                           <h6><asp:Label runat="server" ID="LabelPeticionesPorAsignar_total"></asp:Label></h6>
                                                   ...
                                                   <div class="card info-card revenue-card">
                                                     ...
                                                     <div class="card-body">
                                                       ...
                                                       <div class="d-flex align-items-center">
                                                         ...
                                                         <div class="ps-3">
                                                           <h6><asp:Label runat="server" ID="LabelPeticionesAsignadas_total"></asp:Label></h6>
                                                       ...
                                                       <h5 class="card-title">Asignar petición <span>| a unidad administrativa</span></h5>
                                                        ...
                                                        <div class="row mb-3">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        <h5 class="card-title">Petición <span>| a asignar</span></h5>
                                                                        <asp:DropDownList ID="DropDownListAsignarPeticion_unidad" runat="server" AutoPostBack="true" DataSourceID="SqlDataSourceDropDownAsignarPeticion_unidad"
                                                                        ...
                                                                        <asp:SqlDataSource ID="SqlDataSourceDropDownAsignarPeticion_unidad" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionDES %>"
                                                                            SelectCommand="select ID_PERFIL, 
                                                                                            ...
                                                                                            from CAT_PERFILES where CLAVE_ZP = @UA">
                                                                            <SelectParameters>
                                                                                <asp:ControlParameter ControlID="DropDownListAsignarPeticion_ua" Name="UA" PropertyName="SelectedValue" />
                                                                            </SelectParameters>
                                                                        </asp:SqlDataSource>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="card">
                                                                    <div class="card-body">
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                                <h5 class="card-title">Unidad <span>| administrativa</span></h5>
                                                        ...
                                                        <div class="d-grid gap-2">
                                                            ...
                                                            <asp:Button runat="server" ID="ButtonRegistrarAsignarPeticion_guardar" OnClick="ButtonRegistrarAsignarPeticion_guardar_Click" Text="Actualizar" style="display:none"/>
                                                        </div>

                                                        </ContentTemplate>
                                                             <Triggers>
                                                                 <asp:PostBackTrigger ControlID="ButtonRegistrarAsignarPeticion_guardar" />
                                                             </Triggers>
                                                         </asp:UpdatePanel>
                                                     </div>
                                                   </div>
                                             ...
                                             <div class="col-lg-4">
                                               ...
                                               <div class="card">
                                                 ...
                                                 <div class="card-body pb-0">
                                                   <h5 class="card-title">Departamento <span>| distribución</span></h5>

                                                   <div id="peticionesChart" style="min-height: 400px; user-select: none; position: relative;" class="echart" _echarts_instance_="ec_1762475541695"><div style="position: relative; width: 257px; height: 400px; padding: 0px; margin: 0px; border-width: 0px;"><canvas style="position: absolute; left: 0px; top: 0px; width: 257px; height: 400px; user-select: none; padding: 0px; margin: 0px; border-width: 0px;" data-zr-dom-id="zr_0" width="257" height="400"></canvas></div><div class=""></div></div>
    ...
    <script>
        ...
        function validarCollapse() {
            ...
            $('.accordion-collapse').on('hide.bs.collapse', function (e) {
                ...
                switch (idCollapse) {
                    ...
                    case 'collapseContenido_filtroEventos':
                        ...
                        break;
                    case 'collapseContenido_filtroAsignarPeticion':
                        $("[id*=HiddenFieldCollapseAsignarPeticion_selected]").val("0");
                        break;
                }
            ...
            $('.accordion-collapse').on('show.bs.collapse', function (e) {
                ...
                switch (idCollapse) {
                    ...
                    case 'collapseContenido_filtroEventos':
                        ...
                        break;
                    case 'collapseContenido_filtroAsignarPeticion':
                        $("[id*=HiddenFieldCollapseAsignarPeticion_selected]").val("1");
                        break;
                }
            });
            ...
            let collDepSt = $("[id*=HiddenFieldCollapseAsignarPeticion_selected]").val();
            ...
            if (collDepSt == "1") { ActivarCollapse("collapseContenido_filtroAsignarPeticion"); }
        ...
        function chartPieCategorias() {
            ...
            var datos = $("[id*=HiddenFieldGraficoPiePeticiones_datos]").val();

            if (datos.length == 0) { datos = '[{"value":0,"name":"Sin datos"}]'; }
            //else { datos = JSON.parse(datos); }

            echarts.init(document.querySelector("#peticionesChart")).setOption({
                tooltip: {
                    trigger: 'item'
                },
                legend: {
